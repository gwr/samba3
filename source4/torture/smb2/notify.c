...
static bool torture_smb2_notify_close_after(struct torture_context *torture,
					    struct smb2_tree *tree1,
					    struct smb2_tree *tree2)
{
	bool ret = true;
...
struct torture_suite *torture_smb2_notify_init(void)
{
	...
	torture_suite_add_2smb2_test(suite, "close-after",
				     torture_smb2_notify_close_after);
